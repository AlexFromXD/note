...
if __name__ == "__main__":
    ...
    with open(join(current_dir, "data/valid-user.json")) as f:
        ...
        user = User(**data)
        print(user)
        # address=Address(street='123 Maple Street', city='Springfield', zip='12345') age=18 active=True
    ...
    with open(join(current_dir, "data/invalid-user.json")) as f:
        ...
        # active
        # Field required [type=missing, input_value={'address': {'zip': 12345}, 'age': 18}, input_type=dict]
        #     For further information visit https://errors.pydantic.dev/2.10/v/missing
