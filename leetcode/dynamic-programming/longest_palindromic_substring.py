...
class Solution:
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(s)):
            ...
            word1 = self._checkPalindrome(s, i, i)
            # this is for even length palindrome
            word2 = self._checkPalindrome(s, i, i+1)
    ...
    def _checkPalindrome(self, s, lo, hi):
...
assert solution.longestPalindrome(
    'babad') == "bab" or solution.longestPalindrome('babad') == "aba"
